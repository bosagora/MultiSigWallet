...
const TestCalls = artifacts.require("TestToken");
...
contract("MultiSigWallet", (accounts) => {
    ...
    */
    ...
    it("callReceive1uint", async () => {
        ...
        const transactionId = utils.getParamFromTxEvent(
            await multisigInstance.submitTransaction(callsInstance.address, 67890, receive1uintEncoded, {
                from: accounts[0],
            }),
            "transactionId",
            null,
    ...
    it("callReceive2uint", async () => {
        ...
        const transactionId = utils.getParamFromTxEvent(
            await multisigInstance.submitTransaction(callsInstance.address, 4040404, receive2uintsEncoded, {
                from: accounts[0],
            }),
            "transactionId",
            null,
    ...
    it("callReceive1bytes", async () => {
        ...
        const transactionId = utils.getParamFromTxEvent(
            await multisigInstance.submitTransaction(callsInstance.address, 10, receive1bytesEncoded, {
                from: accounts[0],
            }),
            "transactionId",
            null,
